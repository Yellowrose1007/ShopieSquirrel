    ...
    <div>
  {
    ...
    (<div className="flex gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
      ...
      <div className="md:w-[30%] w-full flex flex-col gap-8 justify-between">
        ...
        <div className="mt-20">
          <p className="text-xl text-amber-600 uppercase font-[600]">Your Cart</p>
          <p className="text-5xl font-[600] text-amber-600 uppercase mb-4">Summary</p>
        ...
        <div className="mb-20">
          ...
          border-2 border-amber-200 hover:bg-white hover:text-amber-200 transition-all duration-300 ease-in">
            CheckOut Now
          </button>
        </div>
    ...
    (<div className="w-screen h-[calc(100vh-80px)] flex flex-col gap-6 justify-center items-center">
      ...
      <Link to={"/"}>
        <button className="bg-amber-600 text-white text-md uppercase font-[600] py-3 px-10 rounded-md
        border-amber-600 border-2 hover:bg-white hover:text-amber-600 ease-in transition-all duration-300">
          Shop Now
        </button>
      </Link>
    </div>)
